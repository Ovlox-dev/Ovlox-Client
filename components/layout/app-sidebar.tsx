    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "GitHub", url: `${integrationBase}/github`, providerId: "github" },
          { title: "Slack", url: `${integrationBase}/slack`, providerId: "slack" },
          { title: "Jira", url: `${integrationBase}/jira`, providerId: "jira" },
          { title: "Linear", url: `${integrationBase}/linear`, providerId: "linear" },
          { title: "Discord", url: `${integrationBase}/discord`, providerId: "discord" },
        ],
      },
      {
        title: "Members",
